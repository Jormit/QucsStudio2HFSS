...
class Rectangle:
    ...
    def __str__(self):
        return "XStart: {}\nYStart: {}\nZStart: {}\nWidth: {}\nHeight: {}\n".format(
            self.XStart, self.YStart, self.ZStart, self.Width, self.Height
        )
...
class Substrate:
    ...
    def __str__(self):
        return "Height: {}\Thickness: {}\LossTangent: {}\nPermittivity: {}".format(
            self.Height, self.Thickness, self.LossTangent, self.Permittivity
        )
...
def parse(filename):
    ...
    return (
        rectangles,
        Substrate(Height, Thickness, LossTangent, Permittivity, BoundingBox),
    )
